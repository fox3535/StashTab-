...
**Packet status:** `1.1.2 BACKEND ON DRAFT PR #1 — HEAD 4d317f8 — REQUIRED CI GREEN — NOT MERGED — NOT DEPLOYED`
...
| Local 1.1.2 backend acceptance | Human | `ACCEPTANCE-1.1.2.md`; two disposable PostgreSQL 16.14 runs 21/21; SQLite 178 passed | **APPROVED 2026-08-25** locally; later pushed as draft PR #1 |
...
| Feature-branch push / draft PR | Human | `feature/backend-notification-v1.1.2` on GitHub; draft PR #1 | **OPEN DRAFT** — not ready, not merged, not deployed |
...
| **FRONTEND-AUTHENTICATED-API-TRANSPORT-GATE** | Human + frontend | Existing admin/POS callers send Clerk bearer; shop id is a hint | Implemented in merge-readiness pass on this PR; awaiting owner ready-for-review |
...
Standing: draft PR only. No merge, deploy, production migration, live Web Push, or production credentials.
