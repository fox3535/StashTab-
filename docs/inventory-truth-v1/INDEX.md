...
18. `ACCEPTANCE-F2-SLICE-01-CONTROLLED-RECEIVE.md` (merged on `main` via PR #31 `a354fed`; not deployed)
19. `CHECKPOINT-F2-SLICE-01-STAGING-PROVISIONING.md` (prepared, not executed)
