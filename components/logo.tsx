...
/** StashTab brand mark — ultraviolet monogram. */
export function StashTabMark({ className }: { className?: string }) {
    return (
        <span
            className={cn(
                'relative flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-md border border-neon/40 bg-gunmetal font-display text-sm font-bold text-neon',
                className
            )}
        >
            <span
            ...
            />
            <span className="relative text-glow-accent">ST</span>
        </span>
    )
}
